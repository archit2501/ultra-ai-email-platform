  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        error:
          "border-transparent bg-error text-error-foreground hover:bg-error/90 shadow-sm",
        info:
          "border-transparent bg-info text-info-foreground hover:bg-info/90 shadow-sm",
        // Premium variants
        glass:
          "glass border-white/10 text-foreground hover:glass-strong",
        glow:
          "border-transparent bg-primary text-primary-foreground shadow-glow-primary-sm hover:shadow-glow-primary",
        gradient:
          "gradient-primary border-transparent text-white shadow-sm hover:shadow-md",
      },
      size: {
