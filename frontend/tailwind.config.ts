  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        "glow-primary": "0 0 20px hsla(var(--glow-primary), 0.4), 0 0 40px hsla(var(--glow-primary), 0.2)",
        "glow-primary-sm": "0 0 10px hsla(var(--glow-primary), 0.3), 0 0 20px hsla(var(--glow-primary), 0.15)",
        "glow-accent": "0 0 20px hsla(var(--glow-accent), 0.4), 0 0 40px hsla(var(--glow-accent), 0.2)",
        "glow-success": "0 0 20px hsla(var(--glow-success), 0.4), 0 0 40px hsla(var(--glow-success), 0.2)",
        "glow-cyan": "0 0 20px hsla(var(--glow-cyan), 0.4), 0 0 40px hsla(var(--glow-cyan), 0.2)",
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
      ...
      animation: {
        ...
        // Continuous animations (use sparingly, respect prefers-reduced-motion)
